 ...
 * 芯片: Ai8051, 3.3v
  ...
  功能点:
  1. RGB驱动: 8个RGB灯(RGB-WS2812B)驱动，RGB-KEY控制，
  2. 亮度调节: 亮度调节，亮度调节按键控制
  3. 菜单: 菜单按键控制，菜单按键控制
  4. 电池电压,p0.0/ ADC8
  5. 太能阳充电开启检测， P0.1 高电平
  6. 外部USB充电开启， P0.2 高电平
  7. 光感测: 光感强度电压值， P0.3/ADC11 (二期开发)
  8. 温度测: 当前内部环境温度 （二期开发） p0.4 /ADC12
  9. 充电检测: 充电检测，充电检测按键控制
  10. 充电指示: 充电指示，充电指示
